...
personalidade = st.sidebar.selectbox("Personalidade", ["Professor de contabilidade", "Professor de História","Cientista maluco"] )

descricao = {
    "Professor de contabilidade": "Você é um professor de contabilidade que entende muito sobre conversões de moedas ", 
...
if pergunta:
    ...
    with st.chat_message("assistant"):
        with st.spinner("Agente processando..."):
            ...
            contexto =""
            if personalidade == "Professor de contabilidade":
